...
/*NON-MODIFIABLE SINGLE-TABLE VIEW due to aggregation*/
...
/*NON-MODIFIABLE SINGLE-TABLE VIEW due to distinct*/
...
/*NON-MODIFIABLE SINGLE-TABLE VIEW due to subquery referencing same table*/
...
/*JOIN VIEW not permitted in SQL standard*/
